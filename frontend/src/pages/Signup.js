...
/**
 * Signup Page
 * Users create a new account with name, email, and password.
 */
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login({ name: userName, email: userEmail }, token);
  ...
  /**
   * OAuth signup - same as login, Google/GitHub handles it.
   */
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <p>Start removing backgrounds for free today</p>
